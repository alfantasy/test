...
M.BufferingBar = function(value, size_arg, circle)
    ...
    if circle then
        ...
        DrawList:AddRectFilled(pos, imgui.ImVec2(pos.x + circleStart, pos.y + size.y), ToU32(imgui.GetStyle().Colors[imgui.Col.Button]))
        DrawList:AddRectFilled(pos, imgui.ImVec2(pos.x + circleStart * value, pos.y + size.y), ToU32(imgui.GetStyle().Colors[imgui.Col.ButtonHovered]))
        ...
        DrawList:AddCircleFilled(imgui.ImVec2(pos.x + circleEnd - o1, pos.y + r), r, ToU32(imgui.GetStyle().Colors[imgui.Col.Button]))
        DrawList:AddCircleFilled(imgui.ImVec2(pos.x + circleEnd - o2, pos.y + r), r, ToU32(imgui.GetStyle().Colors[imgui.Col.Button]))
        DrawList:AddCircleFilled(imgui.ImVec2(pos.x + circleEnd - o3, pos.y + r), r, ToU32(imgui.GetStyle().Colors[imgui.Col.Button]))
    else
